<?php
	...
	use Monitoring\Exception\InvalidArgumentException;
	use Monitoring\Exception\InvalidPacketException;
	use Monitoring\Exception\SocketException;
	 ...
	 * @package Monitoring
	 *
	 * @uses Monitoring\Exception\InvalidArgumentException
	 * @uses Monitoring\Exception\InvalidPacketException
	 * @uses Monitoring\Exception\SocketException
	 */
	class SourceQuery
	{
		/**
